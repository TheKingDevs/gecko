...
// are approved. Three states are stored in a per-task value by the
...
// ResetServiceIndicator clears the service indicator for the running task.
...
// task since the last ResetServiceIndicator call are approved.
//
// If ResetServiceIndicator was not called before by this task, its return
// value is undefined.
