...
//
// A Pool is safe for use by multiple tasks simultaneously.
//
...
// load (when many tasks are actively printing) and shrinks when
// quiescent.
//
...
// pin pins the current task to P, disables preemption and
