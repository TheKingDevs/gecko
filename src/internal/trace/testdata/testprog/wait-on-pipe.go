...
// Tests a task sitting blocked in a syscall for
...
func main() {
	...
	// Create a task that blocks on the pipe.
	...
	// Give the task ample chance to block on the pipe.
	...
	// Wait for the task to unblock and start running.
	// This is helpful to catch incorrect information written
	// down for the syscall-blocked task, since it'll start
