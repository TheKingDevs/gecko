...
// sequence number for e.g. a task in the previous
...
func gen(t *testgen.Trace) {
	...
	// The running task gets unblocked.
	...
	// Start running the task, but later.
	...
	// The task starts running, then stops, then starts again.
