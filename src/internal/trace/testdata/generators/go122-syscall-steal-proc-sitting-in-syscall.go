...
// Tests syscall P stealing from a task and thread
...
func gen(t *testgen.Trace) {
	...
	// Steal proc from a task that's been blocked
	...
	// Status event for a task blocked in a syscall for the entire generation.
