...
// IsInBubble reports whether the current task is in a bubble.
//
...
// Acquire returns a reference to the current task's bubble.
...
// The current task must not be part of a bubble.
