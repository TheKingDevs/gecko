...
const (
	...
	// V5: adds gecko export overrides. A per-object flag
	// indicates whether the (export/private) visibility of a
	// top-level declaration was overridden by the gecko `export`
	// keyword, and a per-package flag tags packages compiled from
	// gecko (.gk) source files.
	V5
...
const (
	...
	// GeckoExport marks packages compiled from gecko (.gk) source
	// files and top-level declarations whose visibility was
	// overridden by the gecko `export` keyword.
	GeckoExport
