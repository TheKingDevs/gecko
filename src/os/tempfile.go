...
// Multiple programs or tasks calling CreateTemp simultaneously will not choose the same file.
...
// Multiple programs or tasks calling MkdirTemp simultaneously will not choose the same directory.
