...
func main() {
	...
	doTypes := func(w io.Writer) {
		...
		fmt.Fprint(w,
			`// Code generated by 'go run -C $GKROOT/src/simd/archsimd/_gen/midway'; DO NOT EDIT.
...
`)
	...
	for _, aaf := range archAndFiles {
		...
		doArchWrites := func(w io.Writer) {
			...
			pf("// Code generated by 'go run -C $GKROOT/src/simd/archsimd/_gen/midway'; DO NOT EDIT.\n\n")
