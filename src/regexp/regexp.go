...
// A Regexp is safe for concurrent use by multiple tasks,
...
//
// Deprecated: In earlier releases, when using a [Regexp] in multiple tasks,
// giving each task its own copy helped to avoid lock contention.
