...
// Both types should be used by a single task at a time: sharing among
// multiple tasks requires some kind of synchronization.
//
// Top-level functions, such as [Float64] and [Int],
// are safe for concurrent use by multiple tasks.
//
...
//
// A Source is not safe for concurrent use by multiple tasks.
...
func globalRand() *Rand {
	...
	if !globalRandGenerator.CompareAndSwap(nil, r) {
		// Two different tasks called some top-level
