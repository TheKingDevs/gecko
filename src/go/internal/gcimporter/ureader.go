...
func (r *reader) doPkg() *types.Package {
	...
	// gecko: the writer always records whether the package is a gecko
	// package. There's nothing to do with it for go/types, but we must
	// still consume the bit.
...
func (pr *pkgReader) objIdx(idx pkgbits.Index) (*types.Package, string) {
	...
	if objPkg.Scope().Lookup(objName) == nil {
		...
		// gecko: the writer may prefix the object data with an `export`
		// visibility override. go/types has no concept of this, but we
