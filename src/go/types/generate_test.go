...
var filemap = map[string]action{
	...
	"package.go":    func(f *ast.File) { renameIdents(f, "MarkGecko->_MarkGecko", "IsGecko->_IsGecko") },
	"pointer.go":    nil,
	"predicates.go": nil,
	...
	"scope.go": func(f *ast.File) {
		fixTokenPos(f)
		renameIdents(f, "InsertLazy->_InsertLazy", "SetGeckoExported->_SetGeckoExported", "GeckoExported->_GeckoExported")
	},
	"selection.go": nil,
