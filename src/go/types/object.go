...
func (obj *object) Exported() bool {
	...
	if obj.pkg != nil && obj.pkg._IsGecko() {
...
func (obj *object) _SetGeckoExported(b bool) { obj.geckoExported = &b }

// GeckoExported reports the gecko export override for this object,
// or nil if no override is set.
func (obj *object) _GeckoExported() *bool { return obj.geckoExported }
