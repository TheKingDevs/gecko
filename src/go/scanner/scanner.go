...
type Scanner struct {
	...
	// Gecko enables the gecko syntax extension: the identifiers "while",
	// "class", "new" and "export" are recognized as keywords. It is set by
	// the parser for source files with the .gk extension.
	Gecko bool
}
