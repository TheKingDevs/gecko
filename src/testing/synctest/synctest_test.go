...
func TestCleanup(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		// synctest.Test will wait for this task to exit before returning.
		// The cleanup function signals the task to exit before the wait starts.
		go func() {
			<-ch
			done = true
		}()
...
func TestContext(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		// Wait blocks until the task above is blocked on t.Context().Done().
		synctest.Wait()
	...
	// and synctest.Test does not return until the task has set its state to "done".
