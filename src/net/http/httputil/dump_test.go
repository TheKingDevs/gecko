...
var dumpTests = []dumpTest{
	...
	// with a bytes.Buffer and hang with all tasks not
	// runnable.
	{
...
func TestDumpRequest(t *testing.T) {
	...
	// to test that no tasks are leaked. See golang.org/issue/32571.
	...
	// Validate we haven't leaked any tasks.
	var dg int
	...
	for time.Now().Before(dl) {
		...
		// Allow tasks to schedule and die off.
		runtime.Gosched()
	}
