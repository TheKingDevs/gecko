...
// Setting DebugGoroutines to false during a test to disable task debugging
// results in race detector complaints when a test leaves tasks running before
...
//
// Disable task debugging during individual tests with an atomic bool.
...
func curGoroutineID() uint64 {
	...
	// Parse the 4707 out of "task 4707 ["
