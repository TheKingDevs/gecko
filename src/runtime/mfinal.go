...
var (
	...
	fing        *g        // task that runs finalizers
...
func createfing() {
	// start the finalizer task exactly once
...
// This is the task that runs all of the finalizers.
func runFinalizers() {
	var (
...
// finalizer(obj) in a separate task. This makes obj reachable again,
...
// file descriptor opened by a different task). To avoid this problem,
// call KeepAlive(p) after the call to syscall.Write.
//
// A single task runs all finalizers for a program, sequentially.
...
okarg:
	...
	// make sure we have a finalizer task
	createfing()
