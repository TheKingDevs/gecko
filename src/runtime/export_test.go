...
// ShrinkStackAndVerifyFramePointers attempts to shrink the stack of the current task
...
func RunGetgThreadSwitchTest() {
	...
	// switch. If we yield to the sender task, it will
...
// that the scheduler gets a chance to preempt the task.
func GoschedIfBusy() {
	goschedIfBusy()
}
...
func (s *Scavenger) Start() {
	...
	// Start up scavenger task, and wait for it to be ready.
