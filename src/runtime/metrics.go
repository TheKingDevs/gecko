...
func metricsLock() {
	...
	// expensive enough that queueing up tasks and handing off between
...
// an approximate count of tasks in each state.
...
func (a *schedStatsAggregate) compute() {
	...
	// Compute the number of blocked tasks. We have to
	// include system tasks in this count because we included
	// them above.
