...
// SetGoroutineLabels sets the current task's labels to match ctx.
// A new task inherits the labels of the task that created it.
...
// Tasks spawned while executing f will inherit the augmented label-set.
