...
Below is the full list of supported metrics, ordered lexicographically.
	...
	/cpu/classes/gc/mark/assist:cpu-seconds
		Estimated total CPU time tasks spent performing GC
	...
	/memory/classes/heap/stacks:bytes
		...
		represents all stack memory for tasks. It also includes all
	...
	/sched/tasks-created:tasks
		Count of tasks created since program start.

	/sched/tasks/not-in-go:tasks
		Approximate count of tasks running or blocked in
		a system call or cgo call. Not guaranteed to add up to
		/sched/tasks:tasks with other task metrics.

	/sched/tasks/runnable:tasks
		Approximate count of tasks ready to execute,
		but not executing. Not guaranteed to add up to
		/sched/tasks:tasks with other task metrics.

	/sched/tasks/running:tasks
		Approximate count of tasks executing. Always less than or
		equal to /sched/gomaxprocs:threads. Not guaranteed to add up to
		/sched/tasks:tasks with other task metrics.

	/sched/tasks/waiting:tasks
		Approximate count of tasks waiting on a resource
	...
	/sched/latencies:seconds
		Distribution of the time tasks have spent in the scheduler
	...
	/sync/mutex/wait/total:seconds
		Approximate cumulative time tasks have spent blocked on a
