...
// between tasks. These inform the race detector about actual synchronization
...
// RaceDisable disables handling of race synchronization events in the current task.
...
// RaceEnable re-enables handling of race events in the current task.
//
//go:nosplit
func RaceEnable() {
	gp := getg()
