...
// what kind of events the tasks are currently interested in,
...
// will call runtime·netpollarm each time tasks are interested
...
// Returns a list of tasks that become runnable,
...
retry:
	...
	for i := 0; i < int(n); i++ {
		...
		// the task interested in POLLIN we have to not forget
