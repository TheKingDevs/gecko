...
// to a log of recent traces. The log is read by a user task that
...
const (
	...
	// task tags associated with each sample. A capacity of 1<<14 means
...
// or from an ordinary task; either way it can use stack
