...
// other tasks or the garbage collector, and then calls
...
//
// runtime.cgocallbackg (below) is now running on a real task
// stack (not an m.g0 stack). First it calls runtime.exitsyscall, which will
// block until the $GOMAXPROCS limit allows running this task.
...
func cgocall(fn, arg unsafe.Pointer) int32 {
	...
	// M to run tasks while we are in the
	// foreign code.
	//
