...
// Code generated by 'gecko test cmd/gecko -v -run=^TestDocsUpToDate$ -fixdocs'; DO NOT EDIT.
// Edit the documentation in other files and then execute 'gecko generate cmd/gecko' to generate this one.

// Gecko is a tool for managing Gecko source code.
//
// Usage:
//
//	gecko <command> [arguments]
//
// The commands are:
//
...
//	env         print gecko environment information
...
//	test        test packages
//	tool        run specified gecko tool
//	version     print gecko version
//	vet         report likely mistakes in packages
//	work        workspace maintenance
//
// Use "gecko help <command>" for more information about a command.
//
// # Start a bug report
//
// Usage:
...
// Usage:
//
//	gecko build [-o output] [build flags] [packages]
//
...
// Usage:
//
//	gecko clean [-i] [-r] [-cache] [-testcache] [-modcache] [-fuzzcache] [build flags] [packages]
//
...
// Usage:
//
//	gecko doc [doc flags] [package|[package.]symbol[.methodOrField]]
//
...
//
// # Print gecko environment information
//
// Usage:
//
//	gecko env [-json] [-changed] [-u] [-w] [var ...]
//
...
// Usage:
//
//	gecko fix [build flags] [-fixtool prog] [fix flags] [packages]
//
...
//
// # Generate gecko files by processing source
//
// Usage:
//
//	gecko generate [-run regexp] [-n] [-v] [-x] [build flags] [file.go... | packages]
//
...
// Usage:
//
//	gecko install [build flags] [packages]
//
...
// Usage:
//
//	gecko list [-f format] [-json] [-m] [list flags] [build flags] [packages]
//
...
//
// # Compile and run gecko program
//
// Usage:
//
//	gecko run [build flags] [-exec xprog] package [arguments...]
//
...
// Usage:
//
//	gecko test [build/test flags] [packages] [build/test flags & test binary flags]
//
...
//
// # Run specified gecko tool
//
// Usage:
//
//	gecko tool [-n] command [args...]
//
...
// Usage:
//
//	gecko vet [build flags] [-vettool prog] [vet flags] [packages]
//
...
//
// Use "gecko help work <command>" for more information about a command.
// Edit go.work from tools or scripts
//
// Usage:
//
//	gecko work edit [editing flags] [go.work]
//
...
// Usage:
//
//	gecko work vendor [-e] [-v] [-o outdir]
//
