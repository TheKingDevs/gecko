...
func TestMain(m *testing.M) {
	...
	testGOPATH = true // force GOPATH mode; module test is in cmd/gecko/testdata/script/mod_doc.txt
	...
	// Add $GOROOT/src/cmd/gecko/internal/doc/testdata explicitly so we can access its contents in the test.
	...
	dirsInit(
		Dir{importPath: "cmd/gecko/internal/doc/testdata", dir: testdataDir},
		Dir{importPath: "cmd/gecko/internal/doc/testdata/nested", dir: filepath.Join(testdataDir, "nested")},
		Dir{importPath: "cmd/gecko/internal/doc/testdata/nested/nested", dir: filepath.Join(testdataDir, "nested", "nested")})
...
const p = "cmd/gecko/internal/doc/testdata"
...
var tests = []test{
	...
	// Package dump includes import, package statement.
	{
		"package clause",
		[]string{p},
		[]string{`package pkg.*cmd/gecko/internal/doc/testdata`},
		nil,
	},
