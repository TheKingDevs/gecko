...
// Package vcstest serves the repository scripts in cmd/gecko/testdata/vcstest
...
// scripts in cmd/gecko/testdata/vcstest.
func NewServer() (srv *Server, err error) {
	if vcs.VCSTestRepoURL != "" {
		panic("vcs URL hooks already set")
	}

	scriptDir := filepath.Join(testenv.GOROOT(nil), "src/cmd/gecko/testdata/vcstest")
