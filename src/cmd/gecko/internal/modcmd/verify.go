...
modules have been changed and causes 'gecko mod' to exit with a
non-zero status.

See https://go.dev/ref/mod#go-mod-verify for more about 'gecko mod verify'.
	`,
	Run: runVerify,
}
...
func runVerify(ctx context.Context, cmd *base.Command, args []string) {
	...
	if len(args) != 0 {
		...
		base.Fatalf("gecko: verify takes no arguments")
	}
