...
func (r *toolchainRepo) Versions(ctx context.Context, prefix string) (*Versions, error) {
	...
	// This means that the development branch of Go 1.21 (say) will allow 'gecko get go@1.21'
...
func (r *toolchainRepo) Stat(ctx context.Context, rev string) (*RevInfo, error) {
	...
	if gover.IsLang(v) {
		...
		return nil, fmt.Errorf("gecko language version %s is not a toolchain version", rev)
	}
