...
// It must be safe for simultaneous use by multiple tasks.
type Repo interface {
...
// introduced, if a path p resolves using the pre-module "gecko get" lookup
...
// Because the "gecko get" import paths rsc.io/qr and github.com/rsc/qr
