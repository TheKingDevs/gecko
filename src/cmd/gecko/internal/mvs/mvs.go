...
//
// It must be safe to call methods on a Reqs from multiple tasks simultaneously.
...
//
// target is the root vertex of a module requirement graph. For cmd/gecko, this is
