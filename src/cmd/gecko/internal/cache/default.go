...
Run "gecko clean -cache" if the directory is getting too large.
Run "gecko clean -fuzzcache" to delete the fuzz cache.
...
func DefaultDir() (string, bool, error) {
	...
	// initDefaultCache. cmd/gecko/main.go explicitly sets GOCACHE so that
