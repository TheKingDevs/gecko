...
// Package help implements the “gecko help” command.
package help
...
func Help(w io.Writer, args []string) {
	// 'gecko help documentation' generates doc.go.
	if len(args) == 1 && args[0] == "documentation" {
		...
		fmt.Fprintln(w)
		fmt.Fprintln(w, "// Code generated by 'gecko test cmd/gecko -v -run=^TestDocsUpToDate$ -fixdocs'; DO NOT EDIT.")
		fmt.Fprintln(w, "// Edit the documentation in other files and then execute 'gecko generate cmd/gecko' to generate this one.")
		fmt.Fprintln(w)
...
Args:
	for i, arg := range args {
		...
		helpSuccess := "gecko help"
		if i > 0 {
			helpSuccess += " " + strings.Join(args[:i], " ")
		}
		counterErrorsHelpUnknownTopic.Inc()
		fmt.Fprintf(os.Stderr, "gecko help %s: unknown help topic. Run '%s'.\n", strings.Join(args, " "), helpSuccess)
		base.SetExitStatus(2) // failed at 'gecko help cmd'
		base.Exit()
	}
	...
	// not exit 2: succeeded at 'gecko help cmd'.
	return
}
...
Use "gecko help{{with .LongName}} {{.}}{{end}} <command>" for more information about a command.
`
