...
const (
	...
	// V5: adds an `export` visibility override per object and a per-package
	// gecko flag, used by the gecko language extension.
	V5
...
const (
	...
	// Objects may carry an `export` visibility override and packages a
	// gecko flag.
	GeckoExport
