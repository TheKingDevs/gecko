...
/*
 * Helpers for building cmd/gecko and cmd/cgo.
 */
...
//
// It is invoked to write cmd/gecko/internal/cfg/zdefaultcc.go
// but we also write cmd/cgo/zdefaultcc.go
func mkzdefaultcc(dir, file string) {
	if strings.Contains(file, filepath.FromSlash("gecko/internal/cfg")) {
