...
Vet is normally invoked through the gecko command.
...
whereas this one vets the packages whose path is provided:
	...
	gecko vet my/project/...

Use "gecko help packages" to see other ways of specifying which packages to vet.
...
To list the available checks, run "gecko tool vet help":
	...
	testinggoroutine report calls to (*testing.T).Fatal from tasks started by a test
...
For details and flags of a particular check, such as printf, run "gecko tool vet help printf".
