...
func tcCall(n *ir.CallExpr, top int) ir.Node {
	...
	if l.Op() == ir.ONAME && l.(*ir.Name).BuiltinOp != 0 {
		...
		case ir.OAPPEND, ir.ODELETE, ir.OMAKE, ir.OMAX, ir.OMIN, ir.OPRINT, ir.OPRINTLN, ir.ORECOVER, ir.OINPUT:
			n.SetOp(l.BuiltinOp)
			n.Fun = nil
...
// tcInput typechecks an OINPUT node, input(...any) string.
func tcInput(n *ir.CallExpr) ir.Node {
	typecheckargs(n)
	for i, a := range n.Args {
		n.Args[i] = DefaultLit(a, nil)
	}
