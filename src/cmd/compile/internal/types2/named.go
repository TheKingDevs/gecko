...
func (n *Named) lookupMethod(pkg *Package, name string, foldCase bool) (int, *Func) {
	n.unpack()
	// In gecko packages, methods are accessible to importing packages
	// regardless of capitalization (see object.Exported).
	gecko := n.obj.pkg != nil && n.obj.pkg.gecko || pkg != nil && pkg.gecko
	if samePkg(n.obj.pkg, pkg) || isExported(name) || foldCase || gecko {
