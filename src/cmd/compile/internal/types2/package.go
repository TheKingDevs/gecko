...
type Package struct {
	...
	gecko     bool   // package compiled from gecko (.gk) source files
...
// IsGecko reports whether the package was compiled from gecko (.gk)
// source files.
func (pkg *Package) IsGecko() bool { return pkg.gecko }

// MarkGecko marks a package as compiled from gecko source files.
func (pkg *Package) MarkGecko() { pkg.gecko = true }
