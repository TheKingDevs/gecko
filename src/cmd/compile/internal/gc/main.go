...
func Main(archInit func(*ssagen.ArchInfo)) {
	...
	dwarfgen.RecordFlags("B", "N", "l", "msan", "race", "asan", "shared", "dynlink", "dwarf", "dwarflocationlists", "dwarfbasentries", "smallframes", "spectre", "geckotype")
	...
	for nextFunc, nextExtern := 0, 0; ; {
		...
		// The SSA backend supports using multiple tasks, so keep it
