...
func checkScriptReadme(t *testing.T, engine *script.Engine, env []string) {
	...
	if *fixReadme {
		...
		t.Logf("\n%s", diff)
		t.Errorf("%s is stale. To update, run 'gecko generate cmd/go'.", readmePath)
	}
}

const readmeTmpl = `
This file is generated by 'gecko generate cmd/go'. DO NOT EDIT.

This directory holds test scripts *.txt run during 'gecko test cmd/go'.
To run a specific script foo.txt

	gecko test cmd/go -run=Script/^foo$
...
The cmd/go test flag -testwork (which must appear on the "gecko test" command line after
