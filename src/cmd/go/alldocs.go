...
// Code generated by 'gecko test cmd/go -v -run=^TestDocsUpToDate$ -fixdocs'; DO NOT EDIT.
// Edit the documentation in other files and then execute 'gecko generate cmd/go' to generate this one.
