...
func Help(w io.Writer, args []string) {
	...
	if len(args) == 1 && args[0] == "documentation" {
		...
		fmt.Fprintln(w)
		fmt.Fprintln(w, "// Code generated by 'gecko test cmd/go -v -run=^TestDocsUpToDate$ -fixdocs'; DO NOT EDIT.")
		fmt.Fprintln(w, "// Edit the documentation in other files and then execute 'gecko generate cmd/go' to generate this one.")
		fmt.Fprintln(w)
