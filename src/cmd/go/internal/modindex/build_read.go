...
// declaration so that readString can read the final quoted path. The gecko
// TS forms are "import x from \"p\"", "import { a, b } from \"p\"" and
// "import x, { a, b } from \"p\""; none of the tail tokens contain a quote,
// so we consume characters until the opening quote of the path string.
