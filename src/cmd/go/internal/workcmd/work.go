...
// Package workcmd implements the “gecko work” command.
package workcmd
...
root modules by the gecko command for builds and related operations.  A
...
containing the module's go.mod file. The gecko command does not resolve
