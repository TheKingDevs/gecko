...
// This will leave a task running until either both channels are closed
...
// is sent on the returned channel. This will leave a task running
...
// This will leave a task running until the context is canceled
...
// An Exclusive is a value that may only be used by a single task
...
//
// This is a convenient way to exit a task sending values when
